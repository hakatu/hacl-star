...
val gcm256_encrypt_opt':
  ...
  Stack unit
    ...
    (ensures fun h0 _ h1 ->
      ...
      (let cipher, tag = gcm_encrypt_LE AES_256 (seq_nat32_to_seq_nat8_LE (Ghost.reveal key)) (be_quad32_to_bytes iv_BE) plain_bytes auth_bytes in
      cipher == cipher_bytes /\
      (length_div tag_b;
...
inline_for_extraction
let gcm256_encrypt_opt_stdcall key plain_b plain_len auth_b auth_len iv_b out_b tag_b keys_b hkeys_b scratch_b =
  let h0 = get() in
