...
int main() {
  ...
  uint8_t comp[114] = {0};
  Hacl_Chacha20_Vec32_chacha20_encrypt(in_len,comp,in,k,n,1);
  printf("computed:");
  for (int i = 0; i < 114; i++)
    printf("%02x",comp[i]);
  printf("\n");
  ...
  Hacl_Chacha20_Vec128_chacha20_encrypt(in_len,comp,in,k,n,1);
  printf("computed:");
  for (int i = 0; i < 114; i++)
    printf("%02x",comp[i]);
  printf("\n");
  ...
  Hacl_Chacha20_Vec256_chacha20_encrypt(in_len,comp,in,k,n,1);
  printf("computed:");
  for (int i = 0; i < 114; i++)
    printf("%02x",comp[i]);
  printf("\n");
...
*/
  ...
  for (int j = 0; j < ROUNDS; j++) {
    Hacl_Chacha20_Vec32_chacha20_encrypt(SIZE,plain,plain,key,nonce,1);
  }
  ...
  for (int j = 0; j < ROUNDS; j++) {
    Hacl_Chacha20_Vec128_chacha20_encrypt(SIZE,plain,plain,key,nonce,1);
  }
  ...
  for (int j = 0; j < ROUNDS; j++) {
    Hacl_Chacha20_Vec256_chacha20_encrypt(SIZE,plain,plain,key,nonce,1);
  }
